...
@Query("Select o from Product o where o.name=:name and o.category.id=:category_id and o.hang.id=:brand_id and o.sole.id=:sole_id and o.shoeLine.id=:shoeline_id")
